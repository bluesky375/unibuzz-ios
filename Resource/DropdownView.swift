...
//                optionButton.setTitleColor(self.tintColor, for: .normal)
                optionButton.setTitleColor(UIColor.init(hex: "#58468C"), for: .normal)
            }
        }
    }
...
//            optionButton.setBackgroundColor(color: optionHighlightColor, forState: .highlighted)
//            optionButton.setTitleColor(self.tintColor, for: .normal)
//            optionButton.setTitleColor(UIColor(UIColor.init(hex: "#58468C"), for: .normal), for: <#UIControl.State#>)
            optionButton.setTitleColor(UIColor.init(hex: "#58468C"), for: .normal)
