...
class UtilityHelper
{
    ...
    static func showOKAlert(_ title: String, message: String, target: UIViewController)
    {
        ...
        let okAction: UIAlertAction = UIAlertAction(title: "OK".localized(), style: .default, handler: nil)
    ...
    {
        let alertController: UIAlertController = UIAlertController(title: title, message: message, preferredStyle: .alert)
        let helpAction: UIAlertAction = UIAlertAction(title: "Help".localized(), style: .default, handler: handler)
        let okAction: UIAlertAction = UIAlertAction(title: "OK".localized(), style: .default, handler: nil)
    ...
    {
        let alertController: UIAlertController = UIAlertController(title: title, message: message, preferredStyle: .alert)
        let continueAction: UIAlertAction = UIAlertAction(title: "Continue".localized(), style: .default, handler: handler)
...
//    }
    ...
    class func requiredHeightForLabelWith(_ width:CGFloat , text:String) -> CGFloat{
