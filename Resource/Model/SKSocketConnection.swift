...
//            debugPrint(socketEvent.event)
            if socketEvent.event == "sendMessageEvent" {
            }

            else if socketEvent.event == "Receiver" {
                ...
                NotificationCenter.default.post(name: NSNotification.Name(rawValue: "messageReciverBadgeCount"), object : message, userInfo : nil)
